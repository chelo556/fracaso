...
public class httpHandler {
  ...
  public String indice(String posturl){
	  ...
	  try {
		   ...
		   * esto quiere decir en pocas palabras anexamos los parametros al objeto para que al enviarse al servidor 
		  ...
		  //return e.toString();
		  return "Error de conexión con el servidor\nFavor de verificar la dirección";
